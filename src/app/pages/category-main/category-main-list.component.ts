...
import { CategoryMainUiService } from './category-main-ui.service';
...
export class CategoryMainListComponent implements OnInit {
  constructor(
    protected uiService: CategoryMainUiService,
...
onSearch(){
  ...
  this.service.search(this.param).subscribe({
    next: (result: {results: CategoryMain[], param: QueryParam}) => {
