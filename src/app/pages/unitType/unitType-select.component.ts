...
@Component({
  selector: 'app-unitType-select',
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => UnitTypeSelectComponent),
    multi: true,
  }],
  template: `
    <nz-select
...
export class UnitTypeSelectComponent implements OnInit, ControlValueAccessor {
  constructor(
