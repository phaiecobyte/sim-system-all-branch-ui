  ...
  template: `
    ...
    <div  class="modal-content">
        ...
        <form nz-form [formGroup]="frm" (ngSubmit)="onSubmit()" [nzAutoTips]="autoTips" >
          <nz-form-item >
            <nz-form-label [nzSm]="6" [nzXs]="24" nzRequired>{{'Name/Company/Guest' | translate}}</nz-form-label>
...
export class VendorAddComponent implements OnInit{
  constructor(
      protected modal: NzModalRef<VendorAddComponent>,
