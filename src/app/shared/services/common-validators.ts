import {
  ...
  UntypedFormControl, UntypedFormGroup, ValidationErrors,
  ValidatorFn,
  Validators,
} from '@angular/forms';
...
export class CommonValidators extends Validators {
  ...
  static override maxLength(maxLength: number): ValidatorFn {
    return (control: AbstractControl): { maxlength: { en: string; km_KH: string } } | null => {
      ...
      new Observable((observer: Observer<Validators | null>) => {
        ...
        setTimeout(() => {
          if (control.value && control.status) {
            ...
            service
              .exists(control.value, id, params)
  ...
  static mustMatch(controlName: string, matchingControlName: string) {
    return (formGroup: any):MyValidationErrors | null => {
